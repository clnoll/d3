...
http://vast-mesa-9447.herokuapp.com/.


Simple scatterplot showing wind chills in Chicago, using Yahoo's weather API.  App is set to query the API every "2 hours" (actually every 3 seconds for the demo purposes).
